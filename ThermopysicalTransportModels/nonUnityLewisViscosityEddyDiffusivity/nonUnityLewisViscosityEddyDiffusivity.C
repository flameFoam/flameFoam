...
nonUnityLewisViscosityEddyDiffusivity<TurbulenceThermophysicalTransportModel>::
...
template<class TurbulenceThermophysicalTransportModel>
bool
nonUnityLewisViscosityEddyDiffusivity<TurbulenceThermophysicalTransportModel>::read()
{
    if
    (
        unityLewisEddyDiffusivity<TurbulenceThermophysicalTransportModel>
...
nonUnityLewisViscosityEddyDiffusivity<TurbulenceThermophysicalTransportModel>::q() const
{
...
template<class TurbulenceThermophysicalTransportModel>
tmp<fvScalarMatrix>
nonUnityLewisViscosityEddyDiffusivity<TurbulenceThermophysicalTransportModel>::divq
(
    volScalarField& he
) const
{
